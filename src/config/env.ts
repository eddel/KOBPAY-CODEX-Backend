...
const envSchema = z.object({
  ...
  OTP_PROVIDER: z.enum(["DEV", "BULKSMS", "TRACKSEND"]).default("DEV"),
  ...
  TRACKSEND_BASE_URL: z.string().default("https://api.tracksend.co"),
  TRACKSEND_LEGACY_BASE_URL: z.string().default("https://tx.tracksend.co"),
  TRACKSEND_API_TOKEN: z.string().default(""),
  TRACKSEND_SENDER_ID: z.string().default("Tracksend"),
  TRACKSEND_COUNTRY_ISO_CODE: z.string().default("NG"),
  TRACKSEND_CALLBACK_URL: z.string().default(""),
  SMS_FALLBACK_TO_DEV: z.coerce.boolean().default(false),
